...
![Pipeline from input data through the three functions to the final deliverable.](treecrown/docs/pipeline.png){#fig-pipeline width=80%}
...
![Sketch of the expected demo output (rough map of the route coloured by exposure).](treecrown/docs/Output.png){#fig-output width=80%}
